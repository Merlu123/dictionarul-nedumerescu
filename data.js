const DICT = [
  {
    ...
    book:null,
    images:[],
    why:"Ca atunci când ai terminat proiectul vineri și luni se răzgândește șeful și trebuie s-o iei de la capăt",
    story:"Dacă scoți de la naftalină <i>„Legendele Olimpului”</i> și o răsfoiești un pic, vei da la un moment dat de povestea regelui Sisif. Pe mine mă amuză rău de fiecare dată când o citesc. Omul ăsta e cu adevărat penal! <br><br>Sisif era regele cetății Ephyra (Corintul de azi), un om cu bune și cu rele. A adus prosperitate cetății sale, dar și a căsăpit toți vizitatorii care au venit la el în palat (și știm din <i>„Odiseea”</i> lui Christopher Nolan de Legea lui Zeus că este <i>a big no-no</i>). Cum am spune azi, a furat, dar a și făcut. Poate că zeii ar fi închis ochii și nu și-ar fi bătut capul cu el, dacă nu s-ar fi băgat în problemele lor.<br><br>La un moment dat, lui Zeus i s-au aprins călcâiele (pentru a nu știu câta oară) după o nimfă, Aegina (se pronunță <i>Egina</i>), așa că a făcut cel mai gentleman lucru: s-a transformat într-un vultur uriaș și a luat-o pe sus. Tatăl Aeginei, zeul râurilor a fugit pe urma lor. Drumul l-a adus în Ephyra, unde a cerut audiență la rege să afle dacă i-a văzut fata. Sisif, pe care îl ducea capul, l-a întrebat atunci ce îi iese din toată treaba. Pentru că era zeul râurilor, ăsta i-a promis să îi facă un izvor veșnic în cetate (pesemne așa se făcea dezvoltarea urbană pe atunci). Sisif atunci i-a arătat cu degetul încotro a luat-o vulturul.<br><br>Când a aflat Zeus că Sisif l-a dat în gât (deși tot el a ieșit bine, căci l-a fulgerat bine pe tată și l-a trimis înapoi acasă, iar pe fată a părăsit-o pe o insulă, unde ea i-a născut un fiu), a fost atât de furios că l-a trimis pe Thanatos, zeul morții, să îl lege pe Sisif cu lanțuri în Infern. <br><br>Dar cum spuneam, pe Sisif îl ducea capul. Când să-l lege, a făcut o fază de genul <i>Vai, dar ce lanțuri superbe. Și ce sistem complicat ai proiectat. Chiar ești foarte inteligent. Cred că nimeni nu-ți spune asta prea des. Pun pariu că nimeni nu poate scăpa din ele.</i> Thanatos, ca zeu al morții, cred că nu apucase să învețe cum e cu vrăjeala, așa că a fost flatat și și-a dat drumul la gură. Sisif l-a rugat să-i arate cum funcționează minunatele lanțuri. Îți dai seama ce a urmat. S-a lăsat legat ca prostul și Sisif nu l-a mai eliberat, ba chiar a plecat fluierând înapoi acasă.<br><br>Îți dai seama, cât a rămas blocat Thanatos, nimeni nu mai murea. Ai zice că e super tare. Pentru tine, tânăr/ă în floarea vârstei. Dar ce te faci cu cei bătrâni și bolnavi, blocați într-o veșnică agonie? Nu e  frumos, să știi, să te gândești doar la tine. <br><br>Uită-te la Ares, zeul războiului. El a fost primul care a vrut să repare imediat situația, s-a dus în Infern să vadă care-i treaba și l-a eliberat pe săracul Thanatos. El chiar s-a gândit la oameni. Ce ai zis, Ares? Ai făcut-o pentru că nu e distractiv să te bați dacă nu moare nimeni? Da` bine, mă, fix când am zis și eu că ai făcut o dată ceva bine. Nt nt nt.<br><br>Sisif presimțea că zeii nu au uitat de el și, pentru că, da, ați ghicit, îl ducea capul, a mai pus la cale o șmecherie. Cu puțin timp înainte să moară, a pus-o pe soție să-i arunce trupul în piața cetății, de unde s-a dus pe râu în jos. Ajuns în lumea morților, Sisif s-a dus la Persefona, regina Infernului și a început să o bălăcărească pe nevastă-sa <i>că uită-te la ea, nici înmormântare ca lumea nu i-a făcut</i>. Persefona, care probabil nu prindea acolo jos emisiuni de scandal ca să-și mai alunge din plictiseală i-a dat voie lui Sisif să se întoarcă în lumea celor vii, să o pedepsească și apoi, când termină treaba, să se întoarcă. Al doilea fraier pe ziua de azi.<br><br>Dar știi cum se zice, ulciorul nu merge de multe ori la apă. I-a mers o dată lui Sisif, i-a mers a doua oară, dar a treia oară, <i>mai las-o încolo de treabă</i> și-a zis probabil Zeus. <i>Se crede mai isteț ca zeii? Lasă că eu o să râd la urmă</i>. L-a întors înapoi în Infern și i-a dat o pedeapsă foarte simplă. Să împingă un bolovan uriaș până în vârful unui deal. Sisif s-a conformat, doar că brusc și-a dat seama de șmecherie. Pe măsură ce se apropia de vârf, bolovanul o lua înapoi la vale. Și trebuia să o ia de la capăt. Din nou. Și din nou. Și din nou. Pentru totdeauna.<br><br>Așa am ajuns să avem adjectivul <b>„sisific”</b>, care să descrie un efort care se repetă la nesfârșit, fără să ducă niciodată undeva. Ceva făcut în zadar.<br><br>Ai zice că povestea lui Sisif este una tristă. Morala poveștii: totul e zadarnic până la urmă. Sisif a fost învins. Dar Albert Camus (scriitor și filosof francez) a citit altfel povestea. <i>„Trebuie să ni-l închipuim pe Sisif fericit”</i>. Ai zice că mănâncă ciuperci. Cum să fii fericit să împingi un bolovan până aproape de vârf și să vezi cum se duce înapoi și să o tot iei de la capăt și să nu scapi niciodată de pedeapsa asta? Poți cel mult să înnebunești.<br><br>Dar cum am văzut, Sisif nu e un prost. Când se pune iar să împingă bolovanul, el știe deja care va fi rezultatul. Că nu va putea să ajungă în vârf. Și totuși continuă să îl împingă. De ce? <br><br>Ca să le strice jocul zeilor. Ei vor să vadă un om disperat, chinuit, doborât de sarcina asta absurdă, care să le implore mila. Dar el nu face asta, ci coboară înapoi după bolovan și se pune din nou pe împins. Sisif își împlinește soarta sfidător. El e cel care râde la urmă. <br><br>Și așa este și în viață. Căutarea sensului și a adevărului în universul ăsta fără sens și indiferent este complet zadarnică. Dar asumarea tuturor aceste eforturi repetitive și absurde este singurul act de sfidare pe care îl putem face pentru a fi cu adevărat liberi."
  },
  {
  ...
  },
  {
   ...
   {
    word:"Virginia Evans", aliases:["virginiaevans","virginia evans"],
    phon:"/vir-gI-ni-a E-văns/", tag:"scriitor", tagLabel:"scriitor",
    book:"corespondenta",
    images:[{src:"imagini/virginia.jpg", caption:"Virginia Evans acasă (sursa:https://www.wsj.com)"}],
    why:"Dacă ai nevoie de o poveste motivațională pe bune, tocmai ai găsit-o",
    story:"<b>Virginia Evans</b> s-a născut pe 2 iunie 1986 în Carolina de Sud (stat pe coasta atlantică a Statelor Unite ale Americii), într-o familie americană obișnuită, fără preocupări literare deosebite. Tatăl ei administra azile de bătrâni, iar mama era event planner pentru o companie de catering. În total au fost trei copii. <br><br>În clasele primare, s-a mutat cu familia mai în nord, în statul Maryland (unde de altfel locuiește și personajul ei, Sybil Van Antwerp).<br><br> Era de-a noastră, îi plăcea să citească, așa că a făcut facultatea de literatură engleză la o universitate obișnuită din Virginia, relativ aproape de casă. S-a mutat apoi la Dublin (capitala Irlandei) unde și-a făcut masteratul în scriere creativă pe urmele lui Oscar Wilde și Bram Stoker (nu, că nu sunt gelos), la Trinity College.<br><br>A început să scrie de la 19 ani, într-o rutină zilnică, două ore pe zi între 5 și 7 dimineața. (Ăsta da commitment)  A reușit să scrie 7 romane, dar ai mai auzit cumva numele ei până acum? <i>I don`t think so.</i> Se pare că nu e de ajuns să scrii 7 romane. Mai trebuie să fii și publicat de o editură. În 20 de ani (20 de ani! Numai conștientizează ce eternitate!), a strâns în palmares mii de scrisori de respingere. (Sincer sincerissim, eu după a cincea scrisoare ziceam că scrisul nu e de mine). A încercat peste tot, fie în America, fie în Londra, chiar și în Canada și când n-a mers din prima, a insistat și a doua oară. Și tot n-a renunțat la scris. Pentru că simțea că asta îi place să facă. <br><br>Ireal, frate. Ireal. Din ce material sunt făcuți unii oameni?!<br><br>Nu mai zic că a trebuit să-și improvizeze în cele din urmă biroul într-un dulap. Dar a avut norocul ca de fiecare dată când chiar voia să renunțe, cineva îi spunea să nu o facă. <br><br>Și nu a dat roade.<br><br>Normal că dacă nu a reușit pe partea asta cu scrisul a trebuit să facă tot felul de chestii random: a condus o filială a Rotary Club (o organizație super vagă, n-are rost să dezvolt), i-a planificat programul unui chirurg ortoped (să mă trag de coadă dacă știam că există așa job!), a lucrat pentru un avocat de insolvențe, a fost până și barista. Totul, cât s-a ocupat și de cei doi copii, Jack și Mae. În ultimă fază, s-a gândit chiar să se apuce de Facultatea de Drept, poate își găsește o slujbă mai serioasă (so unfair... încă trăim în lumea în care facultățile de litere sau filosofie nu sunt considerate serioase).<br><br>Și apoi a mai băgat o fisă în pandemie și s-a apucat să scrie o carte total diferită de ce a făcut până atunci. Pentru că, am văzut, femeia e încăpățânată și nu se lasă. <br><br>Și nici măcar <i>„Corespondenta”</i> nu a fost un hit. Același scepticism și <i>mulțumim, așteptați să vă sunăm noi.</i> Săraca Virginia începuse deja să creadă că va fi un luzăr for ever. Și totuși s-a găsit cineva să vadă potențialul. Cartea a fost acceptată și publicată. Și chiar și atunci tot i-a dat emoții. În primele câteva luni, liniște totală. Apoi a decolat mai ceva ca o rachetă.<br><br>Gata, acum Virginia Evans este scriitoare full-time. A ieșit din dulap și și-a făcut propria ei cameră de scris. Lucrează la un nou roman, despre producția unui film, ceea ce e foarte tare. A câștigat prestigiosul <i>Women's Prize for Fiction</i> (unul dintre cele mai mari premii din UK, după Booker Prize). Are chiar și pagină de Wikipedia.<br><br>Într-un moment din ăla adorabil de neîncredere în ce i s-a întâmplat, chiar și-a întrebat agenta: <i>oare o să se vândă următoarea mea carte?</i> Iar ea a râs și i-a zis <i>da, acum da. Toate cărțile ți se vor vinde acum.</i><br><br>La fel ca personajul ei, Sybil, obișnuiește să scrie scrisori, mai ales scriitorilor pe care îi admiră. Și-a făcut curaj și i-a scris lui Ann Patchet să-i spună cum i s-a părut cartea <i>„Commonwealth”</i> și, de atunci au tot continuat să-și scrie. A mers să o cunoască chiar și în persoană, la librăria <i>Parnassus Books</i>. Ann i-a citit cartea și a recomandat-o pe Instagram. (Îți dai seama ce șansă incredibilă avem azi să putem interacționa cu scriitori adevărați? Și totuși încă avem imaginea asta de școală în care scriitorii sunt niște zei neapărat morți).<br><br>Cărți pe care le recomandă: <i>„Regele de Inimă Roșie”</i> de Lily King (tradusă în română, la Editura Trei), <i>„Băiatul adus de mare”</i> de Garrett Carr (ce coincidență, tocmai ce a fost tradusă și în română, la Raftul Denisei), <i>„Întoarcere la Brideshead”</i> de Evelyn Waugh (un period drama tradus la Editura Art). Check them out după ce termini <i>„Corespondenta”</i>.<br><br>Cât îi citești tu acum cartea, ea locuiește în Winston-Salem, Carolina de Nord, cu soțul, cei doi copii, și labradorul lor roșu.<br><br> Și cred că acum e în sfârșit fericită."
  },
  {
    word:"Mark Evans", aliases:["markevans","mark evans"],
    phon:"/mArk E-văns/", tag:"soț", tagLabel:"soț",
    book:"corespondenta",
    images:[],
    why:"Lui Mark, cu dragoste",
    story:"Mark Evans este soțul scriitoarei Virginia Evans. L-a cunoscut pe când era studentă la James Madison University. Lui îi este dedicată prima ei carte, <i>„Corespondenta”</i>. Glumind despre cum a scris cartea într-un dulap și a avut un succes uriaș, i-a spus Virginiei că <i>you should call this your Harry Potter book</i>."
  },
    {
    word:"Ann Patchet", aliases:["annpatchet","ann patchet"],
    phon:"/En pEt-cit/", tag:"scriitor", tagLabel:"scriitor",
    book:"corespondenta",
    images:[{src:"imagini/anne.jpg", caption:"Ann Patchett, în librăria ei Parnassus Books (sursa:https://https://www.oprahdaily.com/)"}],
    why:"Ce e mai tare decât să fii scriitor? Să fii scriitor și să ai și o librărie",
    story:"Cel mai probabil ai zărit numele <b>Ann Patchet</b> prin librării, pe Raftul Denisei. <i>O vară doar pentru noi? Casa olandeză? Comuniune? Belcanto? </i>Se poate să le recunoști vag după copertă.<br><br> Ann Patchett s-a născut pe 2 decembrie 1963 în Los Angeles (<i>how cool is that</i>). Tatăl ei era căpitan de poliție (a fost cel care l-a arestat pe Charles Manson-cel care apare în documentare pe la Netflix și pe Sirhan Sirhan-cel care l-a ucis pe fratele președintelui JF Kennedy), iar mama era asistentă medicală și scriitoare. Are o soră mai mare. Părinții ei au divorțat când era mică și a rămas cu mama, care s-a recăsătorit și s-a mutat în Nashville, la mii de kilometri distanță. Era de-a noastră, îi plăcea să citească, așa că a urmat cursuri de literatură la o universitate americană obișnuită și și-a început cariera de scriitoare încă din studenție. Prima ei povestire a fost publicată în revista <i>Paris Review</i>. Apoi a continuat cu un master în creative writing. <br><br>A debutat la 29 de ani cu romanul <i>„The Patron Saint of Liars”</i> (titlul mi se pare absolut fantastic), care a fost și ecranizat după 6 ani. Apoi cărțile ei au fost nominalizate pe la tot felul de premii literare. În paralel a scris articole în reviste prestigioase ca <i>The New Yorker, The New York Times Magazine, The Oprah Magazine, ELLE, GQ, Vogue.</i><br><br> În 2011, în loc să stea liniștită și să se bucure de succesul cărților sale, a hotărât să-și deschidă o librărie când toată lumea le închidea. Da, aparent nu e o practică mioritică asta cu închisul librăriilor (Forever in our hearts <i>La Două Bufnițe</i>). SUA suferea de aceeași epidemie a librăriilor independente pe cale de dispariție. (Remarcați timpul trecut). Și în condițiile în care scriitorii populari se mutau în marile centre culturale, ea a ales să rămână acasă în banalul Nashville. Așa a apărut <i>Parnassus Books</i> (după muntele din mitologia greacă, căminul literaturii, muzicii și artelor). Și ce chestie, ideea chiar a prins. Apoi, ca să ajungă la cât mai mulți cititorii din zonă, și-a luat un... <b>bookmobile</b>. Efectiv, acum vreau și eu un bookmobile. E ca un autobuz, doar că în interior are rafturi pline cu cărți. <br><br> Cărți pe care le recomandă: <i>„Suferință și extaz”</i> de Meg Mason (tradusă în română la Litera, vine cu un sequel în 2026), <i>„Lincoln între vieți”</i> de George Saunders (tradusă în română chiar de Radu Paraschivescu în Raftul Denisei), <i>„John of John”</i> de Douglas Stuart (în curs de apariție la editura Trei).<br><br>Cât îi citești cărțile, ea locuiește în Nahville cu soțul ei, Karl VanDevender, și are grijă de librărie."
  },
    {
  ...
  },
  {
    ...
    book:"doamnap",
    images:[
  {src:"imagini/ens1.jpg", caption:"ENS pe harta Parisului (sursa:https://www.di.ens.fr)"},
  {src:"imagini/ens2.jpeg", caption:"Vedere aeriană a ENS (sursa:https://psl.eu)"},
],
